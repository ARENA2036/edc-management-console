...
from tractusx_sdk.dataspace.services.connector import BaseConnectorService
...
def init_app(host: str, port: int, log_level: str = "info"):
    ...
    edcDiscoveryService = ConnectorDiscoveryService(oauth=idpManager, discovery_finder_service=discovery_config.get("url",None), connector_discovery_key=discovery_config.get("keys.edc_discovery", "bpn"))
