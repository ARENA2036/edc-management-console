            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-200 px-4 py-3 outline-none transition-colors focus:border-blue-400"
                />
              </div>
              ...
              <div>
                ...
                {initialLinkedConnector && (
                  <p className="mb-2 rounded-xl border border-blue-100 bg-blue-50 px-3 py-2 text-xs leading-5 text-blue-800">
                    {language === 'de'
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full appearance-none rounded-xl border border-gray-200 px-4 py-3 pr-10 outline-none transition-colors focus:border-blue-400 disabled:cursor-not-allowed disabled:bg-gray-100"
                  >
        ...
        <div className="border-t border-gray-100 px-6 py-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="rounded-lg bg-blue-500 px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-blue-600 disabled:cursor-not-allowed disabled:bg-gray-300"
            >
