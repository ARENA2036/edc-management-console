...
import { X } from 'lucide-react'; // Nur 'X' importieren, da 'CheckCircle' nicht verwendet wird
...
export default function DeploymentWizard({ onClose, onDeploy }: Props) {
  ...
  const handleSubmit = () => {
    const newConnector: Connector = {
      ...
      urls: [], // Beispiel, falls du eine URLs-Liste hast
      created_by: 'system', // Beispiel für ein Standardfeld
    };
